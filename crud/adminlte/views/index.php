        ...
        <div class="box-header">
          ...
          <div class="box-tools">
            <div class="input-group input-group-sm" style="width: 150px;">
                <a href="<?="<?="?>Url::toRoute(['<?=Inflector::camel2id(StringHelper::basename($controllerName))?>/create'])<?="?>"?>" class="btn btn-xs btn-primary">添&nbsp;&emsp;加</a>
        			|
...
?>
                ...
                echo '      <a href="'. Url::toRoute(['<?=Inflector::camel2id(StringHelper::basename($controllerName))?>/update', 'id'=>$model->id]) .'" class="btn btn-primary btn-sm" href="#"> <i class="glyphicon glyphicon-edit icon-white"></i>修改</a>';
